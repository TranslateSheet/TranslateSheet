...
// src/helpers/extractTranslations.ts
...
// src/helpers/generatePrimaryLanguageFile.ts
...
// src/helpers/formatTranslatedContent.ts
var formatTranslatedContent = ({
  ...
  const commentForJSOrTS = isPrimary ? `// This file was generated by TranslateSheet.
...
`;
  const messageForJSON = isPrimary ? "This file was generated by TranslateSheet. Do NOT edit this file directly. To change primary language strings, update your TranslateSheet object declarations." : "This file was generated by TranslateSheet. Do NOT edit this file directly. Make changes in the TranslateSheet dashboard.";
  if (fileExtension === ".json") {
    const jsonCopy = __spreadValues({
      _generatedByTranslateSheet: messageForJSON
    }, translatedContent);
    return formatAsJSON_default(jsonCopy);
  } else if (fileExtension === ".ts") {
    const tsContent = formatAsTypeScript_default(translatedContent, targetLanguage);
    return commentForJSOrTS + tsContent;
  } else if (fileExtension === ".js") {
    const jsContent = formatAsJavaScript_default(translatedContent, targetLanguage);
...
// src/api/sendTranslationRequest.ts
...
// src/helpers/requestTranslations.ts
...
`;
  const indexFilePath = import_path4.default.join(
    output,
...
// src/api/uploadPrimaryLanguageContent.ts
var uploadPrimaryLanguageContent = (_0) => __async(void 0, [_0], function* ({
  apiKey,
  targetLanguage,
  content: content2
}) {
...
function createGenerateCommand() {
  const generateCmd = new import_commander.Command("generate").option("--output <output>", "Output directory", void 0).option("--primaryLanguage <primaryLanguage>", "Primary language", void 0).option("--languages <languages>", "Comma-separated list of target languages", void 0).option("--fileExtension <fileExtension>", "File extension", void 0).option("--apiKey <apiKey>", "TranslateSheet API key", void 0).option("--config <config>", "Path to configuration file", "./translateSheetConfig.js").option("--projectId <projectId>", "TranslateSheet Project Id", void 0).action((cmd) => __async(this, null, function* () {
    ...
    try {
      yield uploadPrimaryLanguageContent({
        apiKey: finalApiKey,
...
// src/api/pullTranslationContent.ts
...
// src/helpers/writeTranslationFiles.ts
